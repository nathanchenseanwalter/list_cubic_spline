...
def bezier(ctrl_pt, t_B , fig_points):
    ...
    # INPUT - ctrl_pt: control point tuple array, t_B: polynomial array, fig_points: main points
    # OUTPUT - curve tuples
...
def cardinal(ctrl_pt, t_B, fig_points, tens=0.5):
    ...
    # INPUT - ctrl_pt: control point tuple array, t_B: polynomial array, fig_points: main points, tens: tension (0 to 1)
    # OUTPUT - curve tuples
